...
$string['aioa-colorcodedesc'] = 'You can customize the widget color. For example: FF5733';
...
$string['privacy:metadata'] = 'The All In One Accessibility plugin does not store any personal data.';
